...
/**
 * TestFileMaker implements an application to write a file with several specific
 * tests
 *
 * @author joanapinto
 */
public class TestFileMaker {
    ...
    /**
     * Add an invalid cardinal to a valid line path with n (pathSize) cardinal
     * points.
     *
    ...
    /**
     * Generate a walk in S shape to fill the area of square with half width
     * of radius.
     * @param radius half width of square.
     * @return path to walk
     */
     ...
     * @throws IOException when file to write does not exist.
     */
